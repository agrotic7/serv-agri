    ...
    <footer className="footer-section">
      <div className="footer-newsletter">
        <div className="footer-newsletter-left">
          <img src="/public/servagri_logo.png" alt="SERVAGRI Logo" className="footer-logo" />
      ...
      <div className="footer-main">
        <div className="footer-col address">
          <span className="footer-col-title">Adresse</span>
          <span>3 route de Strasbourg<br/>67500 Haguenau</span>
          <span className="footer-col-title mt">Téléphone</span>
          <span className="footer-phone">03 88 93 85 14</span>
        </div>
